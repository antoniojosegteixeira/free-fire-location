...
class MapWidget2 extends StatefulWidget {
  const MapWidget2({Key? key}) : super(key: key);

  @override
  MapWidgetState createState() => MapWidgetState();
}

class MapWidgetState extends State<MapWidget2> {
            ...
            builder: ((optionsContext, mapType) {
              ...
              List<Marker> generatedUserMarkers =
                  GenerateMarkers.generateUserMarker(
                      customUserMarkerImage: firebaseState.userMarkerImage,
